...
function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed pt-16 top-0 left-0 z-40 w-64 h-screen bg-white dark:bg-gray-800 transform transition-transform md:translate-x-0 ${
          ...
          <nav className="space-y-2">
            ...
            <li className="my-2">
                <Link
                    ...
                    selectedTab === "marketplace" ? "bg-gray-100 dark:bg-gray-700" : ""
                    }`}
                ...
                <li className="my-2">
                     ...
                     <Link
                        to="/generateimage"
                        className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                        selectedTab === "generateimage" ? "bg-gray-100 dark:bg-gray-700" : ""
                        }`}
                ...
                <li className="my-2">
                     ...
                     <Link
                        to="/history"
                        className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                        selectedTab === "history" ? "bg-gray-100 dark:bg-gray-700" : ""
                        }`}
                ...
                <li className="my-2">
                     ...
                     <Link
                        ...
                        className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                        selectedTab === "signout" ? "bg-gray-100 dark:bg-gray-700" : ""
                        }`}
                        onClick={() => openSignOutModal(true)}
                    >
                    {isLogginActive ? (
                        <>
      ...
      >
        ...
        {isSignOutModalOpen && <SignOutModal isOpen={isSignOutModalOpen} onConfirm={handleSignOut} onClose={closeSignOutModal} />}
        <Outlet />
        </div>
      </section>
    </main>
